...
class opt_sp_class:
    ...
    def __init__(
            ...
            d1_bend, d2_bend, sp_bend, rb, eps_x_des, nu_uc_des, nu_sp_des,
...
b_3_list = ["s1_h2", "s2_h2", "s3_h2", "s4_h2"]
...
if step == 1:
    ...
    sp_bend = pc.phi_lat_class(lat_prop, 2, "r1_h1")
...
opt_sp = opt_sp_class(
    ...
    sp_bend, rb, eps_x_des, nu_uc_des, nu_sp_des, beta_des, dnu_des, nld)
