...
uc_0 = lat_prop._lattice.find("d0b", 7).index
uc_1 = lat_prop._lattice.find("d0b", 8).index
sp_1 = lat_prop._lattice.find("sfmh", 1).index
...
b1_list = ["d0b", "df1b", "df2b", "df3b", "df4b", "df5b"]
