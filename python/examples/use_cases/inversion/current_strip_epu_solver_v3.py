#!/usr/bin/env python3
"""
current_strip_epu_57_solver_14.py
...
RELEASE_ID = "EPU57-SOLVER-14-ZERO-CUT-ACCEPTANCE-ATOMIC"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        metavar="FRACTION",
        help=(
            "maximum accepted RMS fit residual divided by RMS target "
            "(default: 0.05)"
        ),
    )
    parser.add_argument(
    ...
    # first field integral on the exact horizontal mid-plane y = 0.
    ...
    fit_target_rms_tm = root_mean_square(target_iy_tm)
    fit_residual_rms_tm = root_mean_square(fit_residual_iy_tm)
    fit_relative_rms = relative_rms_residual(
        fit_residual_iy_tm,
        target_iy_tm,
    )
