...
namespace thor_scsi::elements{
	...
	public:
		...
		inline std::string getDelegatorName(void) const {
			return this->m_delegator_name;
		}

		inline int getDelegatorIndex(void) const {
			return this->m_delegator_index;
		}
	...
	private:
		...
		std::string m_delegator_name;
		int m_delegator_index=-1;
	};
